...
class CacheMemcache extends Cache {
    ...
    function __construct($options=array()) {
        ...
        $options = array_merge(array (
            'host'        =>  C('cache.memcachehost') ? C('cache.memcachehost') : '127.0.0.1',
            'port'        =>  C('cache.memcacheport') ? C('cache.memcacheport') : 11211,
            'timeout'     =>  C('cache.memcachetimeout') ? C('cache.memcachetimeout') : false,
            'persistent'  =>  false,
        ),$options);
